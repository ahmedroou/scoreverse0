...
export const translationsEn = {
  ...
  addResult: {
    ...
    aiHandicapSectionTitle: 'AI Handicap Helper',
    aiHandicapDescription: 'Optionally, get AI-powered handicap suggestions. Adjust player stats below for this match\'s handicap calculation.',
    tempWinRate: 'Temp. Win Rate (%)',
    tempAvgScore: 'Temp. Avg Score',
    getHandicapButton: 'Get Handicap Suggestions',
    fetchingSuggestions: 'Fetching Suggestions...',
    handicapSuggestionsReady: 'Handicap Suggestions Ready!',
    handicapSuggestionsReadyDesc: 'AI has provided handicap recommendations.',
    handicapSuggestionsTitle: 'AI Handicap Suggestions',
    handicapSuggestionItem: '<strong>{{playerName}}:</strong>{{handicapText}}',
    handicapTextWithValue: ` Handicap of {{handicap}}.`,
    noHandicapNeeded: ' No handicap needed.',
    handicapReason: 'Reason: {{reason}}',
    handicapNote: 'Note: Handicaps (if any) will be applied to scores if you record this match now.',
    ...
    toasts: {
      ...
      handicapError: 'Please select a game and players first.',
      handicapMinPlayersError: 'This game requires at least {{count}} players for handicap suggestion.',
      handicapFailed: 'Handicap Suggestion Failed',
      handicapUnexpectedError: 'Received an unexpected response.',
