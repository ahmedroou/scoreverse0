...
export const translationsEn = {
  ...
  spaces: {
    ...
    membersDialog: {
      ...
      description: 'Invite others to view or contribute to this space.',
    ...
    toasts: {
        ...
        inviteSentDesc: '{{email}} has been invited to the space.',
        userNotFound: 'User not found with email: {{email}}.',
        alreadyMember: '{{email}} is already a member of this space.',
        inviteFailed: 'Failed to send invite.',
        memberRemoved: 'Member Removed',
        memberRemovedDesc: '{{username}} has been removed from the space.',
        removeFailed: 'Failed to remove member.',
        roleUpdated: 'Role Updated',
        roleUpdatedDesc: "{{username}}'s role is now {{role}}.",
